...
from discovery_config import DISCOVERY_CONFIG as cfg, CUSTOM_QUERIES_FILE, SEARCH_QUERIES
...
class SearXNGScraper:
    ...
    def search_all_queries(self, queries: Optional[List[Dict[str, str]]] = None) -> List[Dict]:
        ...
        """
        from discovery_config import SEARCH_QUERIES
    ...
    def fetch_document(self, result: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if len(content) > 50000:
                ...
                logger.debug(f"  Truncated to 50000 chars: {url}")
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            if resp.status_code == 200:
                print(f"[OK] SearXNG is running at {self.base_url}")
                return True
        except Exception:
            pass
        ...
        print(f"[FAIL] SearXNG is NOT responding at {self.base_url}")
