...
class PBOResult:
    ...
    def __str__(self) -> str:
        tag = "[WARN]  OVERFIT" if self.is_overfit else "[OK] OK"
        return (
...
class DSRResult:
    ...
    def __str__(self) -> str:
        tag = "[OK] SIGNIFICANT" if self.is_significant else "[WARN]  NOT SIGNIFICANT"
        return (
...
class OverfittingDetector:
    ...
    def generate_tearsheet(
        ...
        if not QUANTSTATS_AVAILABLE:
            print("[WARN]  quantstats not installed. pip install quantstats")
            return None
        try:
            qs.reports.html(returns, benchmark=benchmark, output=output_path, title=title)
            print(f"[OK] Tearsheet -> {output_path}")
            return output_path
        except Exception as e:
            print(f"[WARN]  Tearsheet failed: {e}")
            return None
    ...
    def get_quantstats_metrics(self, returns: pd.Series) -> Dict:
        ...
        try:
            ...
            print(f"[WARN]  quantstats metrics failed: {e}")
            return {}
